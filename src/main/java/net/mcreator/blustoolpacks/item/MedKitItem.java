...
import net.mcreator.blustoolpacks.procedures.MedKitRightclickedProcedure;
...
public class MedKitItem extends BlustoolpacksModElements.ModElement {
	@ObjectHolder("blustoolpacks:med_kit")
	...
	public void initElements() {
		elements.items.add(() -> new ItemToolCustom() {
			...
			public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
				...
				list.add(new StringTextComponent("Heals HP to max"));
			}
			...
			public ActionResult<ItemStack> onItemRightClick(World world, PlayerEntity entity, Hand hand) {
				...
				MedKitRightclickedProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity)).collect(HashMap::new,
		...
		}.setRegistryName("med_kit"));
	}

	private static class ItemToolCustom extends Item {
		protected ItemToolCustom() {
			super(new Item.Properties().group(ItemGroup.FOOD).maxDamage(1).isImmuneToFire());
		}
